...
public class InvoiceMainFrame extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvoiceMainFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private SalesInvoiceListener controller = new SalesInvoiceListener(this);
    ...
    public SalesInvoiceListener getMyController() {
        return controller;
    }
